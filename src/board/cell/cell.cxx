...
// We need to override this hashfunction in order for the Cell object to be
// usable in a hashmap or set
size_t
Cell::HashFunction::operator()(Cell& cell) const
{
...
std::ostream&
operator<<(std::ostream& outs, Cell& cell)
{
